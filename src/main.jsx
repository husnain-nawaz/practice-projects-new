...
// const MyInput = forwardRef((props,ref)=>(
//     <input className='border bg-amber-300' ref={ref} {...props} />
// ));
// function App(){
//     const inputref = useRef();
//     const focusInput = ()=>{
...
//     return(
//         <div>
//             <MyInput ref={inputref} placeholder="Type here ...."></MyInput>
...
//     return(
//         <div>
//             <Greeting name="Husnain" />
//             <Greetingwithborder  name="Mustafa" />
//         </div>
//     )
// }
// createRoot(document.getElementById('root')).render(
